...
const JOBS = [
    {
        ...
        detail: [
            ...
            {
                k: 'stack',
                v: '<span class="chip">TypeScript</span><span class="chip">React</span><span class="chip">Kotlin</span>' +
    ...
    },
    {
        ...
        detail: [
            ...
            {
                k: 'stack',
                v: '<span class="chip">Java</span><span class="chip">Unity</span><span class="chip">AWS</span><span class="chip">Postgres</span><span class="chip">Meta VR SDK</span>'
            },
    ...
    },
    {
        ...
        detail: [
            ...
            {
                k: 'stack',
                v: '<span class="chip">C#</span><span class="chip">Elastic Search</span><span class="chip">ASP.NET</span><span class="chip">Entity</span><span class="chip">RabbitMQ</span>'
            },
        ...
        <section id="experience">
            <div className="shell">
                <div className="sec-head">
                    ...
                    <h2 className="sec-title">Where I've worked <span className="dim">— and what I did there.</span>
                    </h2>
                </div>
                {JOBS.map((job, i) => (
                    <div key={i} className="xp-item">
                        <div>
                            <div className="xp-when">{job.when}</div>
                        </div>
                        <div>
                            <div>
